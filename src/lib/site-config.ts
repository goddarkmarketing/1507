...
export const transferPages = {
  ...
  "hotel-transfer": {
    ...
    featuredRoutes: [
      ...
      ["kbv-airport", "ao-nang-beach"],
      ["kbv-airport", "klong-muang"],
      ["kbv-airport", "tubkaak-beach"],
      ["kbv-airport", "koh-lanta-z1"],
    ] as const,
    vehicleCodes: ["ECO", "PREM", "SUV", "VAN", "EXE", "VIP", "BUS"] as const,
  },
  ...
  "attraction-transfer": {
    ...
    featuredRoutes: [
      ["kbv-airport", "khao-sok"],
      ["kbv-airport", "samet-nangshe"],
      ["kbv-airport", "ratchaprapha-pier"],
      ["kbv-airport", "ao-tha-lane"],
      ["kbv-airport", "had-yao-krabi"],
      ["kbv-airport", "tubkaak-beach"],
    ] as const,
    vehicleCodes: ["ECO", "PREM", "SUV", "VAN", "EXE", "VIP", "BUS"] as const,
  },
